# Mr Chef — Website (Sindagi)

- **Live:** https://shreekantha3.github.io/sindagi-mr-chef/
- **Repo:** `shreekantha3/sindagi-mr-chef` (branch `main` = source, `gh-pages` = deployed bundle where applicable)
- **Stack:** static Vite + Tailwind CSS, no backend. `base: '/sindagi-mr-chef/'` for GitHub Pages project-site hosting.
